...
<body class="font-[Onest]">    
    <header>
        <nav class="wrapper h-16 flex items-center justify-between peer-checked:static">
            ...
            <div
                class="fixed inset-0 -translate-y-full peer-checked:translate-y-0 transition-transform md:static md:translate-y-0 z-40 mt-4 md:mt-0">
                <ul
                    class="absolute inset-x-0 bg-white top-11 py-5 px-11 grid gap-3 md:w-max md:p-0 md:grid-flow-col md:static">
                    <li><a href="index.html" class="hover:text-azul-logo transition ease-in">Inicio</a></li>
                    <li><a href="services.html" class="hover:text-azul-logo transition ease-in">Servicios</a></li>
                    <li><a href="courses.html" class="hover:text-azul-logo transition ease-in">Cursos</a></li>
                    <li><a href="about-us.html" class="hover:text-azul-logo transition ease-in">¿Quiénes Somos?</a></li>
                    <li><a href="contact.php"
                            class="text-white py-2 px-5 bg-azul-logo rounded-full transition ease-in hover:bg-azul-dark">Contacto</a>
                    <li>
                </ul>
            </div>
        </nav>
    ...
    <main>
        <section class="bg-circuito bg-cover bg-no-repeat bg-center h-[250px] grid justify-items-center items-center">
            <article class="text-white text-3xl lg:text-4xl font-[Amaranth]">
                Contáctanos
            </article>
        </section>
        <section class="wrapper mt-14">
            ...
            if (isset($_SESSION['message'])) { ?>
                <article class="bg-azul-logo/30 py-4 pl-3">
                    <?= $_SESSION['message'] ?>
                </article>
            <?php session_unset();
            } ?>
        ...
        <section class="wrapper mt-14 mb-24 grid gap-8 justify-items-center items-center md:grid-cols-2 overflow-visible">
            <img src="./assets/img/brand communication-amico.svg" alt="" data-aos="fade-right">
            <article class="[&>form]:space-y-4 [&>form>div>input]:w-full [&>form>div>input]:border [&>form>div>input]:border-gray-300 [&>form>div>input]:rounded-md [&>form>div>input]:py-2 [&>form>div>input]:px-3 focus:[&>form>div>input]:outline-none focus:[&>form>div>input]:border-azul-logo" data-aos="fade-left">
                <form action="./php/model/submitForm.php" method="post">
                    <div>
                        <label for="name">Nombre Completo</label>
                        <input type="text" name="name" id="name" placeholder="Oscar Perez" required>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="tel" name="phone" id="phone" placeholder="55 1122 3344">
                    </div>
                    <div>
                        <label for="asutno">Asunto</label>
                        <input type="text" name="asunto" id="asunto" placeholder="" required>
                    </div>
                    <div>
                        <label for="mensaje">Mensaje</label>
                        <textarea type="text" name="mensaje" id="mensaje" class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-azul-logo" required>
                        </textarea>
                    </div>
                    <button type="submit" class="inline-block hover:transition-colors bg-gradient-to-r from-[#1dadba] to-[#1f4e5a] hover:from-[#1f4e5a] hover:to-[#1dadba] duration-300 text-white rounded-full py-2 px-5 hover:shadow-xl hover:shadow-gray-300" name="submit">
                        Contáctanos
                    </button>
                </form>
            </article>
    ...
    <footer class="bg-neutral-800 text-white">
        <section
            class="wrapper py-6 lg:py-12 mt-14 text-center space-y-10 [&>article>span]:font-bold lg:grid lg:grid-cols-4 lg:space-y-0 lg:text-left lg:gap-11 lg:[&>article]:space-y-3 hover:[&>article>ul>li>a]:text-azul-logo">
